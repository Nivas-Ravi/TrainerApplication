...
public class Trainer {
	...
	public String toString() {
		return "Trainer [trainerId=" + trainerId + ", trainerName=" + trainerName + ", description="
				+ description.getDescriptionId() + ", city=" + city.getCityId() + ", state=" + state.getStateId()
				+ ", country=" + country.getCountryId() + ", trainerNumber=" + trainerNumber + "]";
	}
